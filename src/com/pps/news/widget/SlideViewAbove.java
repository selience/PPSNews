...
import com.pps.news.widget.SlideNavigationView.OnClosedListener;
import com.pps.news.widget.SlideNavigationView.OnOpenedListener;
...
public class SlideViewAbove extends ViewGroup {
	...
	public SlideViewAbove(Context context) {
		this(context, null);
	}

	public SlideViewAbove(Context context, AttributeSet attrs) {
		super(context, attrs);
		initCustomViewAbove();
	}
	...
	public void setCustomViewBehind(SlideViewBehind cvb) {
		mViewBehind = cvb;
	}
	...
	protected int mTouchMode = SlideNavigationView.TOUCHMODE_MARGIN;
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (activePointerId == INVALID_POINTER)
				break;
			try {
				//系统原因会导致自定义缩放出现IllegalArgumentException异常
	...
	public void scrollTo(int x, int y) {
		...
		((SlideNavigationView)getParent()).manageLayers(getPercentOpen());
	}
